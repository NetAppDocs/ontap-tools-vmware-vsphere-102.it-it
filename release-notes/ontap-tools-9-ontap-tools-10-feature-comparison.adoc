...
[role="lead"]
Scopri se la migrazione dai tool ONTAP per VMware vSphere 9 ai tool ONTAP per VMware vSphere 10,1 o VMware vSphere 10,2 è la soluzione giusta per te. Per informazioni aggiornate sulla compatibilità, vedere https://mysupport.netapp.com/matrix["Tool di matrice di interoperabilità NetApp"^].
