...
+
.. Accedere a *NetApp ONTAP tools* > *protezione* > *host cluster relations*, fare clic sul menu kebab sul cluster e selezionare *Modifica* o.
...
. Se è stato aggiunto un nuovo host ESXi, lo stato di protezione viene visualizzato come parzialmente protetto. Selezionare il menu kebab nelle impostazioni SnapMirror e selezionare *Modifica* per impostare la prossimità dell'host ESXi appena aggiunto.
+
...
. Fare clic su *Salva* dopo aver apportato le modifiche necessarie.
...
. Selezionare il menu kebab nelle impostazioni SnapMirror e selezionare *Elimina*.
